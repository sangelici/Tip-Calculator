$(function() {
    ...
    function handleCalcBtnEnabled() {
        const numOfPeopleNotNil = numOfPeople !== "" && numOfPeople !== "0" && numOfPeople !== undefined;
        if (bill !== undefined && tipPercentage !== undefined && numOfPeopleNotNil) {
    ...
    function handleBillAmount() {
        ...
        $("#billAmount").on("blur", ()=>{
            $("#billAmount").val(bill);
            bill == "0" ? ($("#billAmount").addClass("invalidValueError"), $("#bill-error").show()) : ($("#billAmount").removeClass("invalidValueError"), $("#bill-error").hide());
        });
    ...
    function handleTipPercentage() {
        ...
        if (value !== "custom") {
            ...
            $("#customTipInput").on("blur", ()=>{
                tipPercentage == "0" ? ($("#customTipInput").addClass("invalidValueError"), $("#tip-error").show()) : ($("#customTipInput").removeClass("invalidValueError"), $("#tip-error").hide());
            });
        }
        handleCalcBtnEnabled();
    }
    function handleNumOfPeople() {
        ...
        $("#numOfPeople").on("blur", ()=>{
            numOfPeople == "0" ? ($("#numOfPeople").addClass("invalidValueError"), $("#people-error").show()) : ($("#numOfPeople").removeClass("invalidValueError"), $("#people-error").hide());
        });
        handleCalcBtnEnabled();
    }
    ...
    function handleSubmit() {
        $("#submit-btn").text().trim() === "Calculate" ? calculateTotals() : handleReset();
    }
